...
politic_per=compute_perplexity(arr_politics, n_three_gram, n_two_gram)
print ("Perplexity for business = ",2**(-business_per / len(arr_business)))
print ("Perplexity for politics = ",2**(-politic_per/ len(arr_politics)))
# In the result the perpl for business is less that for politics