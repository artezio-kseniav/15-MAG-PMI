...
base_url = 'http://m.ria.ru/' #http://m.ria.ru/politics/index_10.html
...
# for i in xrange(1, ):
#     time.sleep(0.4)
#     politics_urls += get_news_urls(base_url + '/politics/index_%s.html' % i)

# sport_urls = []
# for i in xrange(1, 15):
#     time.sleep(0.4)
#     sport_urls += get_news_urls(base_url + '/sport/index_%s.html' % i)
